        ...
        dbc.Row(
            [
                dbc.Col(
                    ...
                    html.Div("example: {{Option Type: call, Spot Price:100, Strike Price:100, Risk Free Rate: 5%, Volatility: 20%,Dividend Yield: 2%, Time: 3years, Iterations:[1,2,3,4,5], Execution Style:European}"
